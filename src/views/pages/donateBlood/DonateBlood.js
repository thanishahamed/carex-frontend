import { Badge, Button, Checkbox, MenuItem, Paper, Select } from '@material-ui/core';
...
const DonateBlood = (props) => {
    return (
        <Fade>
            ...
            <Paper className = "p-4 my-2" >
                    <br />
                    <CLabel> 1. Full Name </CLabel>
                    <CInput type = "number" style = {{maxWidth: 500}}className = "mx-3"/>

                    <br />
                    <CLabel> 2. Blood Group </CLabel>
                    <Select
                        // value={age}
                    ...
                    <br/>
                    <br />
                    <CLabel> 3. Last donated date. (If donated only) </CLabel>
                    <CInput type = "date" style = {{maxWidth: 500}}className = "mx-3"/>

                    <br/>
                    <CLabel> 4. Contact numbers. </CLabel>
                    <CInput type = "number" style = {{maxWidth: 500}} disabled className = "mx-3"/>
                    <span className = "mx-3"> Additional Contact Number: </span>
                    <CInput type = "number" style = {{maxWidth: 500}}className = "mx-3"/>

                    <CBadge color = "dark" className = "p-2 my-4"> Agreement (terms and conditions): </CBadge>
                    <ul>
                        <li>
                            You must fulfill several criteria to be accepted as a blood donor. 
                            These criteria are set to ensure the safety of the donor as well as the quality of donated blood.
                        </li>
                    </ul>
                    <CBadge color = "light" className = "p-2 my-4">Donor Selection Criteria</CBadge>
                    <ol>
                        ...
                        <br />
                        <CLabel> <cite> Criteria extracted from: http://www.nbts.health.gov.lk/index.php/donate-blood </cite> </CLabel>
                    </ol>
                    <br />
                    <br />
                    ...
                    <CLabel className = "mx-3 px-4">
                        <Checkbox   
                            ...
                            color="primary"
                        />
                        I accept the following conditions meet at the time I am applying this form.
                    </CLabel>
                    ...
                    <CLabel className = "mx-3 px-4">
                        <Checkbox   
                            ...
                            color="primary"
                        />
                        I agree to do the tests needed to be taken when donating a blood in future.
                    </CLabel>
                    ...
                    <p align = "left">
                        ...
                        <Button color = "primary" variant = "contained"> Proceed to Donate </Button>
                    </p>
